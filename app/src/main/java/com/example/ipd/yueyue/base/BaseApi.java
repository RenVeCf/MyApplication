...
import com.example.ipd.yueyue.bean.EmptyBean;
import com.example.ipd.yueyue.utils.ApplicationUtil;
import com.example.ipd.yueyue.utils.NetWorkUtil;
        ...
        public Converter<ResponseBody, ?> responseBodyConverter(Type type, Annotation[] annotations, Retrofit retrofit) {
            ...
            return new Converter<ResponseBody, Object>() {
                ...
                public Object convert(ResponseBody body) throws IOException {
                    Log.e("TAG","body.contentLength() "+body.contentLength());
                    if (body.contentLength() == 0) return new EmptyBean();
