 ...
 * Time ： 2018/8/26.
 */
public interface BriefSummaryContract {

    interface View extends BaseView {
        //不同的Bean单独处理
        void resultBriefSummary(BriefSummaryBean data);

        <T> ObservableTransformer<T, T> bindLifecycle();
    }

    abstract class Presenter extends BasePresenter<View> {
        public abstract void getBriefSummary(TreeMap<String, String> map, boolean isDialog, boolean cancelable);
    }
}