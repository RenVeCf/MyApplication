...
import com.example.administrator.myapplication.activity.BrowseRecordActivity;
import com.example.administrator.myapplication.activity.MainActivity;
import com.example.administrator.myapplication.activity.ParticularsOfInformationMyActivity;
import com.example.administrator.myapplication.activity.UploadDataActivity;
import com.example.administrator.myapplication.adapter.MyInformationAdapter;
...
import com.example.administrator.myapplication.presenter.MyInformationPresenter;
        ...
        root.findViewById(R.id.bt_dialog_bottom_confirm).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!etDialogForward.getText().toString().trim().equals("")) {
                    LogUtils.i("for_sponsor = " + SPUtil.get(getContext(), IConstants.USER_ID, ""));
                    LogUtils.i("for_proid = " + pro_id);
                    LogUtils.i("for_accept = " + etDialogForward.getText().toString().trim());
                    LogUtils.i("for_watermark = " + rbDialogForwardWatermark.isChecked());
                    LogUtils.i("for_send = " + rbDialogForwardNoForward.isChecked());
                    LogUtils.i("for_download = " + rbDialogForwardNoDownload.isChecked());
                    TreeMap<String, String> loginMap = new TreeMap<>();
